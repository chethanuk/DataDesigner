---
title: "Single-Page QA"
description: ""
---
<Info title="Download Recipe">
  [Download the complete recipe script](https://github.com/NVIDIA-NeMo/DataDesigner/blob/main/fern/assets/recipes/vlm_long_doc/06-single-page-qa-sdg.py)
</Info>
