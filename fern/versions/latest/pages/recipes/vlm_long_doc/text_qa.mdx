---
title: "Text QA from OCR Transcripts"
description: ""
---
<Info title="Download Recipe">
  [Download the complete recipe script](https://github.com/NVIDIA-NeMo/DataDesigner/blob/main/fern/assets/recipes/vlm_long_doc/03-text-qa-sdg.py)
</Info>
