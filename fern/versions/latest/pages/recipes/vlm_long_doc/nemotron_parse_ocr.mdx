---
title: "Nemotron Parse OCR"
description: ""
---
<Info title="Download Recipe">
  [Download the complete recipe script](https://github.com/NVIDIA-NeMo/DataDesigner/blob/main/fern/assets/recipes/vlm_long_doc/02-nemotron-parse-ocr-sdg.py)
</Info>
