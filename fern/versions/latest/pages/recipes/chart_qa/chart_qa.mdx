---
title: "Chart Question Answering"
description: "Generate chart-grounded QA with balanced and difficulty-targeted prompt packs."
---
...
<Info title="Download Recipe">
  [Download the complete recipe script](https://github.com/NVIDIA-NeMo/DataDesigner/blob/main/fern/assets/recipes/chart_qa/chart_qa.py)
</Info>
