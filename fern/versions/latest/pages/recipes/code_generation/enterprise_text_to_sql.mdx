---
title: "Nemotron Super Text to SQL"
description: ""
position: 3
---
<Note>
Dev Note
For a deep dive into the pipeline design, distractor injection strategy, quality waterfall analysis, and BIRD benchmark results, see [Engineering an Enterprise-Grade Text-to-SQL Dataset with NeMo Data Designer](/dev-notes/text-to-sql-for-nemotron-super).
</Note>

<Info title="Download Recipe">
  [Download the complete recipe script](https://github.com/NVIDIA-NeMo/DataDesigner/blob/main/fern/assets/recipes/code_generation/enterprise_text_to_sql.py)
</Info>
