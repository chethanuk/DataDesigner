...
class RunConfig(ConfigBase):
    ...
    adaptive_row_group_admission: bool = Field(
        ...
        description=(
            ...
            "admits one more at a time, up to max_concurrent_row_groups, while model task capacity is not "
            "saturated. If False, max_concurrent_row_groups is a fixed row-group horizon."
        ),
    )
